"""
Configurable SEMIR experiment runner.
Usage:
    python -m semir.run_experiment --psi 0.01 --beta_min 2 --gpu 0 --tag v2b
    python -m semir.run_experiment --psi 0.015 --beta_min 2 --gpu 1 --tag v2c
"""
...
def main():
    ...
    model = SEMIRClassifier(node_dim=7, edge_dim=4, hidden_dim=args.hidden).to(DEVICE)
